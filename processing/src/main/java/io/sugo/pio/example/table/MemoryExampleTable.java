...
public class MemoryExampleTable extends AbstractExampleTable implements GrowingExampleTable {
     ...
     *
     * @param attributes Array of {@link Attribute} containing the attributes of the columns. None of these
     *                   must be null.
     ...
     * Creates a new instance of MemoryExampleTable.
     *
     * @param attributes List of {@link Attribute} containing the attributes of the columns. None of these
     *                   must be null.
     * @deprecated since 7.3. Use methods provided by {@link ExampleSets}.
     */
    @Deprecated

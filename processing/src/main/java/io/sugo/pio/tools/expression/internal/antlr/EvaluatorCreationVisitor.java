...
import io.sugo.pio.tools.expression.internal.antlr.generated.FunctionExpressionParserBaseVisitor;
...
class EvaluatorCreationVisitor extends FunctionExpressionParserBaseVisitor<ExpressionEvaluator> {
     ...
     *
     * @param lookUp the {@link ExpressionContext} for looking up functions, variables and scope
     *               constants
     */
     ...
     *
     * @param text a ATTRIBUTE as defined in FunctionExpressionLexer.g4
     * @return
     */
     ...
     *
     * @param text a SCOPE_CONSTANT or INDIRECT_SCOPE_CONSTANT as defined in
     ...
     *
     * @param text a STRING as defined in FunctionExpressionLexer.g4
     * @return
     */

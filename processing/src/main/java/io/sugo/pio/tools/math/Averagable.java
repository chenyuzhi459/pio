...
import io.sugo.pio.operator.performance.AbsoluteError;
import io.sugo.pio.report.Readable;
 ...
 */
//@JsonSubTypes(value = {
//        @JsonSubTypes.Type(name = "AbsoluteError", value = AbsoluteError.class)
//})
public abstract class Averagable extends ResultObjectAdapter implements Cloneable, Readable {
     ...
     * criteria. Please refer to {@link io.sugo.pio.operator.performance.SimpleCriterion} for a

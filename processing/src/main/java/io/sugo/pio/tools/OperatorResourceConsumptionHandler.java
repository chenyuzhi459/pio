...
import io.sugo.pio.operator.annotation.PolynomialExampleSetResourceConsumptionEstimator;
import io.sugo.pio.operator.annotation.PolynomialFunction;
...
public class OperatorResourceConsumptionHandler {
	...
	private static final Logger LOGGER = new Logger(OperatorResourceConsumptionHandler.class);

	static {
		resourceMap = new HashMap<String, String[]>();
		BufferedReader reader = null;
//		String resource = "/" + Tools.RESOURCE_PREFIX + OPERATORS_RESOURCE_CONSUMPTION;
		String resource = "/" + "com/rapidminer/resources/" + OPERATORS_RESOURCE_CONSUMPTION; // TODO
		try {

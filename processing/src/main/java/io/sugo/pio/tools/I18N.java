...
public class I18N {
	...
	static {
		...
		String localeLanguage = ParameterService.getParameterValue(PROPERTY_RAPIDMINER_GENERAL_LOCALE_LANGUAGE);
		Locale locale = Locale.getDefault();
		if (localeLanguage != null) {
			locale = new Locale(localeLanguage);
			Locale.setDefault(locale);
//			LogService.getRoot().log(Level.INFO, "io.sugo.pio.tools.I18N.set_locale_to", locale);
		} else {
//			LogService.getRoot().log(Level.INFO, "io.sugo.pio.tools.I18N.using_default_locale", locale);
		}
		JComponent.setDefaultLocale(locale);

		USER_ERROR_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle(
				"io.sugo.pioresources.i18n.UserErrorMessages", locale, I18N.class.getClassLoader()));
		ERROR_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle("io.sugo.pioresources.i18n.Errors", locale,
				I18N.class.getClassLoader()));
		GUI_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle("io.sugo.pioresources.i18n.GUI", locale,
				I18N.class.getClassLoader()));
		SETTINGS_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle("io.sugo.pioresources.i18n.Settings",
				locale, I18N.class.getClassLoader()));

		ResourceBundle plotterBundle = ResourceBundle.getBundle("io.sugo.pioresources.i18n.PlotterMessages", locale,
				I18N.class.getClassLoader());
...
//			LogService.getRoot().log(Level.FINE, "io.sugo.piotools.I18N.missing_key", key);
			return key;
		}
	}

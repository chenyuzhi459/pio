...
public class FunctionDescription {
    ...
    public FunctionDescription(String i18nKey, int numberOfArguments, int returnType) {
        ...
        String functionName = key + KEY_SUFFIX_NAME;// I18N.getGUIMessage(key + KEY_SUFFIX_NAME);
        String helpTextName = key + KEY_SUFFIX_HELP;//I18N.getGUIMessage(key + KEY_SUFFIX_HELP);
        String description = key + KEY_SUFFIX_DESCRIPTION;// I18N.getGUIMessage(key + KEY_SUFFIX_DESCRIPTION);
        String groupName = key + KEY_SUFFIX_GROUP;// I18N.getGUIMessage(key + KEY_SUFFIX_GROUP);
        String functionNameWithParameters = key + KEY_SUFFIX_PARAMETERS;//I18N.getGUIMessageOrNull(key + KEY_SUFFIX_PARAMETERS);

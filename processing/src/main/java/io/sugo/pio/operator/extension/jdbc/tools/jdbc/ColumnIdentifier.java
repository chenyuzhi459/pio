...
public class ColumnIdentifier {
    ...
    public String getFullName(boolean singleTable) {
        if(singleTable) {
            ...
            StatementCreator statementCreator = this.databaseHandler.getStatementCreator();
            return statementCreator.makeIdentifier(this.tableName) + "." + statementCreator.makeIdentifier(this.columnName);
        }
    }

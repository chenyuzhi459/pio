...
import io.sugo.pio.operator.learner.functions.linear.LinearRegressionMethod.LinearRegressionResult;
...
public class LinearRegression extends AbstractLearner {
    ...
    double[] performRegression(ExampleSet exampleSet, boolean[] selectedAttributes, double[] means, double labelMean,
        ...
        if (currentlySelectedAttributes > 0) {
            double[] coefficientsWithoutIntercept = io.sugo.pio.tools.math.LinearRegression.performRegression(independent,
    ...
    public String getDefaultFullName() {
        return I18N.getMessage("pio.LinearRegression.name");
    }

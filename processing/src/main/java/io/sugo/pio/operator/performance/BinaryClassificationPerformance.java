...
public class BinaryClassificationPerformance extends MeasuredPerformance {
    ...
    public void startCounting(ExampleSet eSet, boolean useExampleWeights) throws OperatorException {
        ...
        if (!labelAttribute.isNominal()) {
            throw new UserError(null, "pio.error.attribute_wrong_value_type",
                    labelAttribute.getName(), Ontology.ATTRIBUTE_VALUE_TYPE.mapIndex(labelAttribute
        ...
        if (labelAttribute.getMapping().size() != 2) {
            throw new UserError(null, "pio.error.attribute_wrong_number_value",
                    new Object[]{"'" + labelAttribute.getName() + "'",
        ...
        if (predictedLabelAttribute.getMapping().size() != 2) {
            throw new UserError(null, "pio.error.attribute_wrong_number_value",
                    new Object[]{"'" + predictedLabelAttribute.getName() + "'",
        ...
        if (!labelAttribute.getMapping().equals(predictedLabelAttribute.getMapping())) {
            throw new UserError(null, "pio.error.operator.exampleset_incompatible_label_and_prediction");
        }

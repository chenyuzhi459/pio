...
import io.sugo.pio.tools.math.optimization.ec.es.Individual;
...
public class LogisticRegressionOptimization extends ESOptimization {
    ...
    private static final Logger logger = new Logger(LogisticRegressionOptimization.class);
    ...
    public LogisticRegressionOptimization(ExampleSet exampleSet, // training data
        ...
        this(exampleSet, addIntercept, initType, maxIterations, generationsWithoutImprovement, popSize, selectionType,
                tournamentFraction, keepBest, mutationType, crossoverProb, showConvergencePlot, random, null);
    }
    ...
    public LogisticRegressionOptimization(
        ...
        super(-1.0d, 1.0d, popSize,
                ...
                crossoverProb, showConvergencePlot, random, executingOperator);
        ...
        logger.info("Initialize LogisticRegressionOptimization successfully.");
    }

...
public class BasicArithmeticOperationGenerator extends BinaryNumericalGenerator {
	...
	private static final Logger log = new Logger(BasicArithmeticOperationGenerator.class);
	...
	public void setFunction(String name) {
		...
		log.error("io.sugo.pio.generator.BasicArithmeticOperationGenerator.illegal_function_name",

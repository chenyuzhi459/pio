...
public class ExponentialFunctionGenerator extends SingularNumericalGenerator {
	...
	private static final Logger log = new Logger(ExponentialFunctionGenerator.class);
	...
	public void setFunction(String name) {
		...
		log.error("io.sugo.pio.generator.ExponentialFunctionGenerator.illegal_function_name",

...
public class TrigonometricFunctionGenerator extends SingularNumericalGenerator {
	...
	private static final Logger log = new Logger(TrigonometricFunctionGenerator.class);
	...
	public void setFunction(String name) {
		...
		log.error("io.sugo.pio.generator.TrigonometricFunctionGenerator.illegal_function_name",

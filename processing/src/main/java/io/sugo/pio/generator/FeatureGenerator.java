...
public abstract class FeatureGenerator {
    ...
    private static final Logger log = new Logger(FeatureGenerator.class);
    ...
    public static FeatureGenerator createGeneratorForFunction(String functionName) {
        ...
        if (genClass == null) {
            ...
            try {
                ...
                log.error("io.sugo.pio.generator.FeatureGenerator.instantiating_error",
                        genClass.getName());
                return null;
            }
        }
    ...
    public static List<Attribute> generateAll(ExampleTable exampleTable, Collection<FeatureGenerator> generatorList)
        ...
        log.info("io.sugo.pio.generator.FeatureGenerator.starting_feature_generation",
                generatorList.size());
        ...
        log.info("io.sugo.pio.generator.FeatureGenerator.generator_list", generatorList);
        log.info("io.sugo.pio.generator.FeatureGenerator.input_has_feature_count_and_example_count",
        ...
        log.info("io.sugo.pio.generator.FeatureGenerator.finished_feature_generation");
        log.info("io.sugo.pio.generator.FeatureGenerator.generated_set_has_feature_count_and_example_count",
                new Object[]{exampleTable.getAttributeCount(), exampleTable.size()});
    ...
    private static List<Attribute> newAttributes(FeatureGenerator[] generators, ExampleTable exampleTable) {
        ...
        for (int i = 0; i < generators.length; i++) {
            ...
            if (!generators[i].argumentsOk(exampleTable)) {
                log.warn("io.sugo.pio.generator.FeatureGenerator.wrong_argument_types",
                        generators[i]);
            }
        }
        return newAttributeList;

 ...
 */
package io.sugo.pio.studio.io.data.internal;

import io.sugo.pio.core.io.data.ColumnMetaData.ColumnType;
...
import io.sugo.pio.operator.nio.model.*;
import io.sugo.pio.studio.io.data.DefaultDataSetMetaData;
import io.sugo.pio.studio.io.data.HeaderRowBehindStartRowException;
import io.sugo.pio.studio.io.data.HeaderRowNotFoundException;
import io.sugo.pio.studio.io.data.StartRowNotFoundException;
...
//			resultSet.next(null);
	...
	private static int[] getValueTypes(DataResultSet dataResultSet, int startingRow, int headerRow, int numberOfColumns,
		...
		new DataResultSetTranslator(null).guessValueTypes(translationConfiguration, dataResultSet, 100);

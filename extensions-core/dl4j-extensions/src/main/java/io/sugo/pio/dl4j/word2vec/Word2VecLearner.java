...
import io.sugo.pio.example.ExampleSetFactory;
...
public class Word2VecLearner extends Operator {
     ...
     */
    private final InputPort input = getInputPorts().createPort(PortConstant.EXAMPLE_SET_INPUT, PortConstant.EXAMPLE_SET_INPUT_DESC);
    private final OutputPort model = getOutputPorts().createPort(PortConstant.MODEL, PortConstant.MODEL_DESC);
    private final OutputPort vector = getOutputPorts().createPort(PortConstant.VECTOR, PortConstant.VECTOR_DESC);
    ...
    public void doWork() throws OperatorException {
        ExampleSet exampleSet = input.getDataOrNull(ExampleSet.class);
        ...
        // Configuration phase
        iterator = new ExampleSetLineIterator(exampleSet, attributeName);

        TokenizerFactory token = new ChineseTokenizerFactory();
    ...
    public IOContainer getResult() {
        ...
        ioObjects.add(vector.getAnyDataOrNull());

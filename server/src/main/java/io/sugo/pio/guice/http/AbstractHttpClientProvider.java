...
{
  private final Key<Supplier<PioHttpClientConfig>> configKey;
  ...
  {
    configKey = Key.get(
        new TypeLiteral<Supplier<PioHttpClientConfig>>()
        {
        }
    );
  ...
  public Key<Supplier<PioHttpClientConfig>> getConfigKey()
  {
    return configKey;
  }
  ...
  public Provider<Supplier<PioHttpClientConfig>> getConfigProvider()
  {

...
@ManageLifecycle
public class SQLMetadataRecStrategyManager implements MetadataRecStrategyManager {
    private static final Logger log = new Logger(SQLMetadataRecStrategyManager.class);
    ...
    @Inject
    public SQLMetadataRecStrategyManager(

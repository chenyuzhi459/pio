...
import io.sugo.pio.overlord.ImmutableWorkerInfo;
import io.sugo.pio.overlord.config.WorkerTaskRunnerConfig;


/**
 * The {@link io.sugo.pio.overlord.RemoteTaskRunner} uses this class to select a worker to assign tasks to.
 */
...
public interface WorkerSelectStrategy
{
   ...
   *
   * @return A {@link io.sugo.pio.overlord.ImmutableWorkerInfo} to run the task if one is available.
   */
